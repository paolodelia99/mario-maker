...
void IdsMapSystem::tick(World *world, ECS::DefaultTickData data) {
    ...
    auto kineticMapEnt = world->findFirst<IdsMapComponent, KineticEntitiesMapComponent>();
    if (kineticMapEnt) {
        ComponentHandle<IdsMapComponent> kineticMap = kineticMapEnt->get<IdsMapComponent>();
